...
- (a) developing digital systems, standards, and infrastructure for members;
- (b) providing education, research, community support, and ecosystem development;
- (c) supporting privacy-preserving identity, trust, and digital participation systems;
- (d) undertaking any lawful activities consistent with the mission as determined by the General Assembly.
...
- (c) member participation and contribution;
...
- (b) propose motions and resolutions;
- (c) stand for elected positions where eligible;
- (d) access information as set out in this Constitution and Cooperative policies.

4.5 Members must:

- (a) comply with this Constitution and Cooperative policies;
- (b) act in good faith towards the Cooperative and its members;
- (c) contribute to the mission to the extent reasonably possible.

4.6 Membership may be suspended or terminated for:

- (a) breach of this Constitution or Cooperative policies;
- (b) conduct harmful to the Cooperative or its members;
- (c) fraudulent, unlawful or unethical behaviour.
...
- (d) implementation of resolutions of the General Assembly.
...
- (a) by the Board of Stewards; or
- (b) upon written request by not less than ten percent (10%) of the membership.
...
- (b) time, skills, knowledge and other non-financial contributions;
- (c) provision or shared use of infrastructure or resources.

7.2 Any surplus generated by the Cooperative is allocated in the following order of priority:

- (a) operational sustainability, reserves and contingencies;
- (b) community and ecosystem development in line with the mission;
- (c) equitable patronage distributions to members, where approved by the General Assembly.
...
- (a) by the Cooperative; or
- (b) under Cooperative projects,
