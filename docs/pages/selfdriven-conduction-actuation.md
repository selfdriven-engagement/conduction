...
10. Maintain active communication channels and feedback loops with community members
...
11. Coordinate the research working group facilitated by Foundation Founder Members

12. Map, validate, and publish the Universal Skills Set in collaboration with stakeholders across learner growth phases

13. Build and maintain selfdriven apps (Me, My Skills, Facilitate) as enablement tools

14. Research and implement AI-assisted learning pathways within the selfdriven framework

15. Produce pedagogical and didactic research outputs connecting the framework to educational practice
...
16. Deploy and maintain KERI AID generation, key management, and event log processing

17. Implement ACDC credential issuance, verification, and revocation pipelines

18. Build and maintain the selfdriven wallet app (W3C SSI compliant, Cardano compatible)

19. Develop protocol bridges between on-chain (Cardano) and off-chain (cloud) identity layers

20. Document protocol specifications and contribute to open standards development
...
21. Manage SDF token allocation and vesting schedules for Founding, Advisory, and Community members

22. Pursue funding opportunities including Cardano Catalyst proposals and institutional grants

23. Establish service agreements with learning-community organisations for cloud services revenue

24. Publish transparent treasury reports and financial status updates

25. Model long-term sustainability scenarios and maintain minimum 12-month operational runway
...
26. Operate and maintain the selfdriven cloud services infrastructure (AWS)

27. Implement monitoring, alerting, and incident response procedures for all production services

28. Automate deployment, testing, and release processes for selfdriven apps

29. Manage on-chain operations including token generation and NFT access controls on Cardano

30. Document all operational procedures and maintain runbooks for service continuity
...
31. Document and publish governance processes including decision-making protocols for SDF token holders

32. Implement regular reporting cadences (monthly Foundation, quarterly Community)

33. Manage Foundation team member agreements with defined time commitments and role descriptions

34. Establish community governance mechanisms for direction input and resource allocation decisions

35. Track and publish outcome metrics against stated objectives for each Area of Focus
...
36. Define and publish data governance policies covering storage, access, protection, and value

37. Maintain the selfdriven technical architecture as a documented, evolving reference

38. Ensure all Foundation code and framework outputs are published under CC0 Public Domain licence

39. Design and maintain integration APIs connecting selfdriven apps, identity services, and blockchain layer

40. Coordinate cross-area architectural decisions to prevent fragmentation and ensure system coherence
